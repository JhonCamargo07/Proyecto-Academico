...
<body>
    <div class="contenedor">
        ...
        <nav>
            ...
            <ul>
                <li><a href="/proyectoacademico/vistas/estudiante/" class="botones"><span class="icon-user-plus"></span>Mi perfil</a></li>
            </ul>
            <ul>
        ...
        <div class="contenido">
            ...
            <?php 
                if($Usuario == null){
                    echo "<script>alert('Error, al parecer el estudiante no se encuentra en la base de datos.');</script>";
                }else{
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                ...
                <input type="hidden" name="IDEstudiante" value="<?php echo $datos['IDEstudiantePK']; ?>">
                <input type="hidden" name="new_rol" value="<?php echo $datos['Rol']; ?>">

                <div class="inputs">
                    <b><label for="nombre">Nombres:</label></b>
                    <input type="text" name="nombre" id="nombre" placeholder="Nombres del estudiante" class="recolectores" value="<?php echo $datos['NombreEstudiante']; ?>" required>
                </div>

                <div class="inputs">
                    <b><label for="apellido">Apellidos:</label></b>
                    <input type="text" name="apellido" id="apellido" placeholder="Apellidos del estudiante" class="recolectores" value="<?php echo $datos['ApellidoEstudiante']; ?>" required>
                </div>

                <div class="inputs">
                    <b><label for="documento">Número de documento:</label></b>
                    <input type="number" name="documento" id="documento" placeholder="Número de identificacion "class="recolectores" value="<?php echo $datos['DocEstudiante']; ?>" required>
                </div>
                ...
                <div class="inputs">
                    ...
                    <input type="email" name="email" id="correo" placeholder="Correo del estudiante" class="recolectores" value="<?php echo $datos['Email']; ?>" required>
                </div>
