...
<head>
    ...
    <meta name="description" content="Inactivar matricula en el Colegio Rafael Uribe Uribe (IED) Localidad 19 Bogotá - Ciudad Bolívar.">
    ...
    <title>Inactivar Matrícula | Colegio Rafael Uribe Uribe IED</title>
</head>
<body>
    ...
    <div class="contenedor">
        ...
        <nav>
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="#" class="botones activo"><span class="icon-blocked"></span>Inactivar Matricula</a></li>
                </ul>
            </div>
        </nav>
        ...
        <div class="contenido">
            ...
            <h1>Inactivar Matricula</h1>
        
            <form action="inactivar-matricula.php">
