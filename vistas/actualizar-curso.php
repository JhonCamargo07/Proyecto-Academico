...
<head>
    ...
    <meta name="description" content="Crear usuario para la plataforma del Colegio Rafael Uribe Uribe (IED) Localidad 19 Bogotá - Ciudad Bolívar.">
    ...
    <title>Actualizar Curso | Colegio Rafael Uribe Uribe IED</title>
</head>
<body>
    ...
    <div class="contenedor">
        ...
        <nav>
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="#" class="botones activo"><span class="icon-spinner11"></span>Actualizar Curso</a></li>
        ...
        <div class="contenido">
            ...
            <form action="actualizar-curso.php">
