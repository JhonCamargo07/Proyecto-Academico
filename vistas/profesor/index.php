...
<body>
    <div class="contenedor">
        ...
        <nav>
            ...
            <ul>
                <li><a class="botones activo"><span class="icon-user-plus"></span>Mi perfil</a></li>
            </ul>
            <ul>
                <li><a class="botones" href="/proyectoacademico/vistas/profesor/editarPerfil.php"><span class="icon-user-plus"></span>Editar mi perfil</a></li>
            </ul>
        </nav>
        <div class="contenido">
            <h1>Mi perfil</h1>
                <input type="hidden" value="<?php echo $r['IDProfesorPK']; ?>">

                <div class="inputs">
                    <b><label for="nombres-estudiante">Nombres:</label></b>
                    <input type="text" name="nombres-estudiante" id="nombres-estudiante" placeholder="Nombres del estudiante" class="recolectores formulario" value="<?php echo $r['NombreProfesor']; ?>" disabled>
                </div>
                
                <div class="inputs">
                    <b><label for="apellidos-estudiante">Apellidos:</label></b>
                    <input type="text" name="apellidos-estudiante" id="apellidos-estudiante" placeholder="Apellidos del estudiante" class="recolectores formulario" value="<?php echo $r['ApellidoProfesor']; ?>" disabled>
                </div>
                
                <div class="inputs">
                    <b><label for="documento-estudiante">Número de documento:</label></b>
                    <input type="number" name="documento-estudiante" id="documento-estudiante" placeholder="Número de identificacion "class="recolectores formulario" value="<?php echo $r['DocProfesor']; ?>" disabled>
                </div>
